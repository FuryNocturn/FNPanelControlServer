...
# FNPanel: sync this node's clock from the panel (NTP client)
export CONFIGURE_TIMESYNC_CLIENT=false
export TIMESYNC_PANEL_HOST=""
...
ask_timesync_client() {
  output "Keep this node's clock synced with your panel (fixes lag-metric and"
